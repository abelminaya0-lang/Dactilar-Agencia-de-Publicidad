  ...
  return (
    <section id="team" className="relative pt-16 pb-0 md:pt-32 bg-black overflow-hidden flex flex-col items-center">
      ...
      <div className="relative mb-10 md:mb-24 text-center px-4 max-w-6xl mx-auto z-10">
        ...
        {/* Adjusted Typography for Mobile (Smaller and more compact) */}
        ...
        <h2 
          className="font-heading font-[900] text-[3rem] md:text-[14rem] leading-[0.8] uppercase tracking-tighter italic drop-shadow-[0_10px_30px_rgba(217,54,17,0.3)]" 
      ...
      {/* Main Team Photo Section - Replaces the grid */}
      <div className="relative w-full max-w-[1400px] mx-auto px-4 md:px-12 z-10 mb-12 md:mb-20">
        <div className="relative aspect-video md:aspect-[21/9] overflow-hidden rounded-[2px] border border-white/5 group">
          ...
          <img 
            ...
            alt="Dactilar Team"
            className="w-full h-full object-cover grayscale-[0.3] group-hover:grayscale-0 transition-all duration-[2s] scale-100 group-hover:scale-105"
          />
          
          {/* Subtle Brand Overlay */}
          <div className="absolute inset-0 bg-brand-red/5 mix-blend-overlay z-20 pointer-events-none"></div>
          
          {/* Action Caption for Mobile/Desktop */}
          <div className="absolute bottom-4 left-4 md:bottom-10 md:left-10 z-30 flex items-center gap-3">
            ...
            <p className="text-white font-heading font-bold text-[10px] md:text-xs uppercase tracking-[0.4em] opacity-80">
