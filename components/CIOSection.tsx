...
const CIOSection: React.FC = () => {
  ...
  return (
    <section id="cio" className="relative py-20 md:py-28 px-8 bg-black overflow-hidden border-y border-zinc-900/50">
      {/* Background Accent */}
      <div 
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] blur-[100px] rounded-full pointer-events-none opacity-15"
      ...
      <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="relative mb-10 group">
          ...
          <div 
            className="absolute -bottom-1 -right-1 text-white text-[9px] font-bold px-3 py-1 uppercase tracking-widest shadow-lg"
            style={{ backgroundColor: accentColor }}
          >
            Fundador
          </div>
        ...
        <div className="space-y-3">
          <span className="text-zinc-500 font-heading font-bold tracking-[0.4em] text-[9px] uppercase">
            Dactilar Agencia
          </span>
          <h2 className="text-3xl md:text-5xl font-heading font-extrabold uppercase tracking-tight text-white leading-tight">
        ...
        <div className="mt-10 flex items-center justify-center gap-6">
          <a 
            ...
            className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500 hover:text-white transition-colors duration-300"
          >
            TikTok
          </a>
